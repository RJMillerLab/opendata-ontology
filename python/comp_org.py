...
traindomainfile = '/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_output/od_sample_domain_names.json'
tagdomsimfile = '/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_output/tag_domain_sims.json'
tagrepsimfile = '/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_output/tag_rep_sims.json'
tagdomtransprobsfile = '/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_output/tag_dom_trans_probs.json'
keys = []
vecs = np.array([])
domains = []
tagdomains = dict()
...
def get_reps(rep_num, dim_id):
    ...
    json.dump(reps, open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/reps_kmeans_'+str(dim_id)+'.json', 'w'))
    json.dump(repdomains, open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/repdomains_kmeans_'+str(dim_id)+'.json', 'w'))
...
def init_dim(dim_id):
    ...
    domains, dimdomains = [], []
    dimtags = []
    # get the tags of tables in the comparison exp
    alldomains = json.load(open(DOMAIN_FILE))
    selectedtables = json.load(open(SELECTED_TABLES_FILE))
    for dom in alldomains:
        table = dom['name'][:dom['name'].rfind('_')]
        if table in selectedtables:
            dimtags.append(dom['tag'])
    dimtags = list(set(dimtags))
    ...
    json.dump(domainclouds, open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/traindomainclouds_'+str(dim_id)+'.json', 'w'))
    json.dump(domains, open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/traindomains_'+str(dim_id)+'.json', 'w'))
    json.dump(tagdomains, open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/traintagdomains_'+str(dim_id)+'.json', 'w'))
    json.dump(domaintags, open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/traindomaintags_'+str(dim_id)+'.json', 'w'))

    json.dump(dimdomainclouds, open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/dimdomainclouds_'+str(dim_id)+'.json', 'w'))
    json.dump(dimdomains, open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/dimdomains_'+str(dim_id)+'.json', 'w'))
    json.dump(dimtagdomains, open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/dimtagdomains_'+str(dim_id)+'.json', 'w'))
    json.dump(dimdomaintags, open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/dimdomaintags_'+str(dim_id)+'.json', 'w'))

    json.dump(keys, open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/tagnames_'+str(dim_id)+'.json', 'w'))
    json.dump([list(v) for v in vecs], open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/tagvecs_'+str(dim_id)+'.json', 'w'))

    json.dump(reps, open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/reps_'+str(dim_id)+'.json', 'w'))
    json.dump(repdomains, open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/repdomains_'+str(dim_id)+'.json', 'w'))
    print('done saving.')
...
def read_dim(dim_id):
    ...
    domainsfile = '/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/traindomains_'+str(dim_id)+'.json'
    tagdomainsfile = '/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/traintagdomains_'+str(dim_id)+'.json'
    domaincloudsfile = '/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/traindomainclouds_'+str(dim_id)+'.json'
    domaintagsfile = '/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/traindomaintags_'+str(dim_id)+'.json'
    dimdomainsfile = '/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/dimdomains_'+str(dim_id)+'.json'
    dimtagdomainsfile = '/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/dimtagdomains_'+str(dim_id)+'.json'
    dimdomaincloudsfile = '/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/dimdomainclouds_'+str(dim_id)+'.json'
    dimdomaintagsfile = '/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/dimdomaintags_'+str(dim_id)+'.json'
    repsfile =  repdomainsfile

    repsfile = '/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/reps_'+          str(dim_id)+'.json'
    repdomainsfile = '/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/repdomains_'+str(dim_id)+'.json'

    keys = json.load(open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/tagnames_'+str(dim_id)+'.json', 'r'))
    vecs = json.load(open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/tagvecs_'+str(dim_id)+'.json', 'r'))
    vecs = np.array([np.array(v) for v in vecs])

    reps = json.load(open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/reps_'+str(dim_id)+'.json', 'r'))
    repdomains = json.load(open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_tmp/repdomains_'+str(dim_id)+'.json', 'r'))
...
def agg_fuzzy(suffix1, dim_id):
    ...
    json.dump(domain_success_probs, open('comp_output/agg_' + suffix1 + '_' + str(len(domains)) + '_domain_sps.json', 'w'))
    json.dump(success_probs, open('comp_output/agg_' + suffix1 + '_' + str(len(domains)) + '_table_sps.json', 'w'))
    print('initial dsps to %s' % ('comp_output/agg_' + suffix1 + '_' + str(len(domains)) + '_domain_sps.json'))
...
def multidimensional_hierarchy(dim_id):
    ...
    orgfilname = '/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_output/org'+str(dim_id)+'of'+str(dim_num)+'.txt'
    print('saving org to %s' % orgfilname)
    orgh.save(fg, orgfilname)

    json.dump(ls, open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_output/likelihoods_' + str(dim_id) +  '.json', 'w'))
    json.dump(ts, open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_output/times_' + str(dim_id) +  '.json', 'w'))

    json.dump(after_sps, open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_output/fix_train_probs_' + str(dim_id) + '.json', 'w'))
    json.dump(after_dsps, open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_output/fix_train_domain_probs_' + str(dim_id) + '.json', 'w'))
    print('printed after: %s and %s' % ('fix_train_probs_' + str(dim_id) + '.json', 'fix_train_domain_probs_' + str(dim_id) + '.json'))

    json.dump(before_sps, open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_output/agg_train_probs_' + str(dim_id) + '.json', 'w'))
    json.dump(before_dsps, open('/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/comp_output/agg_train_domain_probs_' + str(dim_id) + '.json', 'w'))
...
SELECTED_TABLES_FILE = '/home/fnargesian/FINDOPENDATA_DATASETS/10k/ekg_socrata_tables.json'
...
#get_org_success_probs('comp_output/train_resultfiles.txt', 'comp_output/train_dsps_multidim.json')
#get_org_success_probs('comp_output/test_resultfiles.txt', 'comp_output/test_dsps_multidim.json')
