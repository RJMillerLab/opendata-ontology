...
def multidimensional_hierarchy(dim_num):
    ...
    multi_json = '/home/fnargesian/go/src/github.com/RJMillerLab/opendata-ontology/python/synthetic_output/multidim_dists_' + str(len(alldomains)) + '_' + str(dim_num) + '_f2op.json'
